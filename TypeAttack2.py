...
Listofwordeasy = ["bake","must","fried","birthday","tooth","chase","bee","seven","counting","meet","write","awake","tenth"]

Listofwordmed = ["different","language","mammal","dessert","favorite","beginning","inventor","thoughtful","numeral","laughter","stomach"]

Listofwordhard = ["outrageous","extraordinary","honorary","minimize","contrary","passageway","vertigo","procrastinate","parliament",]

word = random.choice(Listofwordeasy)

def spaceships(cordx,cordy):
...
def MainMenu():
    ...
    while menu:
        ...
        message_display("press P to pause", black, 100, "medium")
...
def GameLoop():
    ...
    # do everything after filling screen in
        ...
        spaceships(spaceship_x,spaceship_y)
